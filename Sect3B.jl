...
using Gadfly, Cairo, DataFrames, Colors, HypothesisTests, ANOVA, GLM, RCall, Compose
@everywhere using Distributions, StatsBase, Distances, SharedArrays

set_default_plot_size(8inch, 8inch/MathConstants.golden)
...
@everywhere function bc_upd_ri(ϵ::Float64, α::Float64, τ::Float64, r_opinion::Float64, n_truthseekers::Int64, n_indifs::Int64, n_radicals::Int64, averaging)
...
function cost_sim_ri(ϵ::Float64, α::Float64, τ::Float64, r_opinion::Float64, n_truthseekers::Int64, n_indifs::Int64, n_radicals::Int64, averaging, n_sim::Int64)
    v= SharedArray{Float64,1}(n_sim)
    @inbounds @sync @distributed for i in 1:n_sim
